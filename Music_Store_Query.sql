...
-- Q2: Which counties have the most invoice?
...
-- Q5: Who is the best cutomer? The cutomer spend the most money will declared the best customer.
-- Write a query that returns the customer who spend the most money?
...
-- Q9:Find how much amount spend by each customer on artist?
-- Write a query to return customer name, artist name & total spend.
